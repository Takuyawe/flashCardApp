...
export const QUIZ_INSTRUCTION = {
  EASY: `この単語"word"に関する日本語の単語を10個ひらがなで書いてください。漢字は使わないでください。また、最後の単語以外の各単語の後に"/"を挿入してください。あと、単語以外は何も書かないでください。`,
  NORMAL_AND_HARD: `この単語"word"に関する日本語の単語を10個書いてください。また、最後の単語以外の各単語の後に"/"を挿入してください。あと、単語以外は何も書かないでください。`,
};
